...
export default function SupportPage() {
  ...
  const handleSubmit = (e) => {
    ...
    console.log("Support submission:", submission);
  ...
  return (
    <main className="min-h-screen flex items-center justify-center p-6">
      <div
        ...
        role="region"
        aria-labelledby="support-preppr-title"
      >
        ...
        <h1
          id="support-preppr-title"
          className="mt-4 text-2xl font-semibold text-[#556452]"
        >
          Support Preppr
        </h1>

        <form onSubmit={handleSubmit} className="mt-4 w-full flex-1 flex flex-col justify-between">
          <div className="space-y-3">
            ...
            <label className="block text-sm text-[#556452]">
              <span className="block text-xs text-[#556452]">How can we help?</span>
              <textarea
                value={message}
